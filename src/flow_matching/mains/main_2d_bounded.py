...
x_0_dist.add_uniform_noise(noise_bound=1)
x_0_train = x_0_dist.tensor

x_1_dist = Distribution(Tensor(make_moons(PARAMS["size_train_set"], noise=0.00)[0]), device=DEVICE)
x_1_dist.add_uniform_noise(noise_bound=0.05)
x_1_train = x_1_dist.tensor

x_0_sample_dist = Distribution.get_uni_distribution(x_0_dist_center, PARAMS["amount_samples"], device=DEVICE)
x_0_sample_dist.add_uniform_noise(noise_bound=1)
x_0_sample = x_0_sample_dist.tensor
