...
x_0_dist_center_0 = [0, 0, 0, -2, -2]
x_0_dist_center_1 = [0, 0, 0, -2, 2]
x_1_dist_center_0 = [0, 0, 0, 2, -2]
x_1_dist_center_1 = [0, 0, 0, 2, 2]
...
model_path = os.path.join(MODEL_SAVE_PATH, "model_5D_double_gauss_twice_ot_2026-02-18_13-41-46.pth")
