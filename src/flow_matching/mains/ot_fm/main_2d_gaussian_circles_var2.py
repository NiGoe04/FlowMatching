...
# steering console
NAME = "2D_gaussian_circles_ot_var2"
FIND_LR = True
...
gmd_x0, gmd_x1, full_transport_dim, w2_sq_pre_calc = get_scenario(SCENARIO, DIM, DEVICE)
...
model_path = os.path.join(MODEL_SAVE_PATH, "model_2D_gaussian_circles_ot_var2_2026-02-25_11-44-33.pth")
