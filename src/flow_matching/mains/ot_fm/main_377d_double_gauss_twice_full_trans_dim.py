...
from src.flow_matching.controller.utils import store_model, load_model_n_dim, calculate_normalized_centers_ftd_dg_twice
...
from src.flow_matching.view.utils import visualize_multi_slider_ndim, visualize_velocity_field_3d, \
    plot_tensor_3d

# steering console
NAME = "377D_double_gauss_twice_ftd_ot"
FIND_LR = True
...
x_0_dist_center_0, x_0_dist_center_1, x_1_dist_center_0, x_1_dist_center_1 = calculate_normalized_centers_ftd_dg_twice(DIM)
...
model_path = os.path.join(MODEL_SAVE_PATH, "model_3D_double_gauss_twice_ftd_2026-02-21_11-35-11.pth")
...
if GENERATE_SAMPLES:
    ...
    plot_tensor_3d(x_1_sample, params=None)
...
if VISUALIZE_FIELD:
    ...
    visualize_velocity_field_3d(time_range, PARAMS["num_times_to_visualize"], PLOT_BOUNDS,
